...
INSERT INTO `sig`.`tbl_proveedor` (`pk_id_proveedor`, `nombre_proveedor`, `direccion_proveedor`, `telefono_proveedor`, `correo_proveedor`, `rubro_proveedor`, `saldo_mes_anterior_proveedor`, `saldo_actual_proveedor`, `cargo_del_mes_proveedor`, `abonos_del_mes_proveedor`, `cargos_acumulados_proveedor`, `abonos_acumulados_proveedor`, `estado_proveedor`) VALUES ('1', 'Activo', '2da calle', '112233', 'admin@gmail', '1', '1', '1', '1', '1', '1', '1', '1');
INSERT INTO `sig`.`tbl_producto` (`pk_codigo_producto`, `nombre_producto`, `fk_codigo_linea`, `fk_codigo_marca`, `existencia_producto`, `costouni_producto`, `preciouni_producto`, `fechaultentrada_marca`, `fechaultsalida_marca`, `estatus_producto`, `fecha_aprox_ingreso`, `productos_por_ingresar`) VALUES ('1', 'Completa', '1', '1', '1.00', '1.00', '1.00', 'a', 'q', '1', 'a', '2');